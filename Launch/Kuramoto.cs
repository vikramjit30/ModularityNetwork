...
namespace NETGen.Dynamics.Synchronization
{
	...
	public class Kuramoto : ContinuousDynamics
	{
        ...
        public Kuramoto(Network n, double K, double UserDefinedcouplingProb, NetworkColorizer colorizer = null, Func<Vertex, Vertex[]> couplingSelector = null) : base(0d, new DenseVector((int) n.VertexCount))
		{
			_network = n;
		...
		{					
            ...
            foreach (Vertex v in _network.Vertices)
			{
               ...
               // Console.WriteLine("Prob Value is: "+CouplingProbability+" Random value : "+ _network.NextRandomDouble());
